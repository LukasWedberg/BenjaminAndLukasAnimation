...
uniform float _NoisTexInten;
uniform float _StraWidt;
uniform float _NoiTexAffStraWidt;
uniform float _ShifAnis;
...
uniform float _LLI_Min;
uniform float _LLI_Max;
//==
...
uniform float3 _RimLigPosi;
uniform float _LightAffectRimLightColor;
uniform float _LigAffRiLigColInte;
...
UNITY_DOTS_INSTANCED_PROP(float, _LigAffRiLigColInte)
...
static float unity_DOTS_Sampled_LigAffRiLigColInte;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_LigAffRiLigColInte = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _LigAffRiLigColInte);
...
#define _LigAffRiLigColInte                                 unity_DOTS_Sampled_LigAffRiLigColInte
